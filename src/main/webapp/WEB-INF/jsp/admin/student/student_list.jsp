                ...
                <div class="ibox-content">
                    <form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/student/list" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  id="studentNumber" name="studentNumber" value="${query.studentNumber }" class="form-control"/>
                    ...
                    <table id="table" data-toggle="table" data-striped="true" data-click-to-select="true" data-mobile-responsive="true">
                        ...
                        <tr>
                             ...
                             <th data-field="student_number" >学号</th>
...
<script>
    ...
    function add() {
        ...
        layer.open({
            ...
            content: "${ctx }/admin/student/detail",
            btn: ['确定', '取消'],
            yes: function(index, layero){ //或者使用btn1
                var detailForm = layer.getChildFrame('form', index);
                console.log(detailForm);
                var studentNumber = $('#studentNumber', detailForm).val();
                if(!!!studentNumber){error('请输入学号.');return false;}
                ...
                var myClass = $('#myClass', detailForm).val();
                if(!!!myClass){error('请输入班级.');return false;}
    ...
    function del() {
        k.layer.del("${ctx }/admin/student/delete");
    }
