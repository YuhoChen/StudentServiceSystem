        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/studentCourse/result" >
                        <!-- 查询开始 -->
                        <div class="form-group">
                            <label   for="courseNumber">课程编号</label>
                            <input type="text"  id="courseNumber" name="courseNumber.courseNumber" value="${query.courseNumber}" class="form-control"/>
                        </div>
                        <div class="form-group">
                    ...
                    <table id="table" data-toggle="table" data-striped="true" data-click-to-select="true" data-mobile-responsive="true">
                        ...
                        <tr>
                            ...
                            <th data-field="course_info" >上课地点</th>
                            <th data-field="course_credit" >学分</th>
                            <th data-field="course_date">上课时间</th>
                        </tr>
                        </thead>
                        <tbody>
